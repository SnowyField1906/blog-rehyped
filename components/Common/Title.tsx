const Shape = () => {
	return (
		<svg
			viewBox="0 0 64 64"
			version="1.1"
			className="h-[35px] w-[35px] lg:h-[45px] lg:w-[45px]"
		>
			<path
				id="SvgjsPath3009"
			...
			<defs>
				<linearGradient
					...
					id="SvgjsLinearGradient3010"
				>
					<stop
						stopOpacity=" 1"
						stopColor="rgba(125, 81, 146)"
						offset="0"
					></stop>
					<stop
						stopOpacity=" 1"
...
const Title = ({ title }: { title: string }) => {
	return (
		<div className="flex place-items-center items-center gap-2 py-10 text-zinc-900">
			<div className="lg:-translate-y-1">
				<Shape />
			</div>
			<h1 className="my-auto font-decoration text-3xl lg:text-5xl">{title}</h1>
		</div>
	)
}
